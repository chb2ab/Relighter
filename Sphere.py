...
# List of methods
# sphFitting(sphere)
# chooseTop(prog, coordinates)
# onpick(event, ax1, prog)
# getTop()
# RotateCords(Cords, angle, axis)
# GlobalToSphere(Cords)
# Rectify(Cords, dirVec)
# UnfoldSphere(Cords, figRadius = 0)
...
# global variables used for manual selection.
previous = None
xtop = 0
ytop = 0
ztop = 0
